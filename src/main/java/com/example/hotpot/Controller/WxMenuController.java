...
public class WxMenuController {
    ...
    public String menuCreateSample(@PathVariable String appid) throws WxErrorException, MalformedURLException {
        ...
        button1.setName("会员专区");
        button1.setKey("V1001_HUIYUAN_REGIN");

        WxMenuButton button11 = new WxMenuButton();
        button11.setType(MenuButtonType.CLICK);
        button11.setName("会员须知");
        button11.setKey("V1001_HUIYUAN_KNOW");
...
//        button2.setUrl("http://mp.weixin.qq.com");
        ...
        button2.setName("最新消息");
        button2.setKey("V1001_NEW_MESSAGE");

        WxMenuButton button3 = new WxMenuButton();
        button3.setType(MenuButtonType.CLICK);
        button3.setName("关于我们");
        button3.setKey("V1001_ABOUT_OURS");

        WxMenuButton button31 = new WxMenuButton();
        button31.setType(MenuButtonType.VIEW);
        button31.setName("楠朝鲜");
        button31.setUrl("http://www.nanchaoxian.cn/about");

        WxMenuButton button32 = new WxMenuButton();
        button32.setType(MenuButtonType.VIEW);
        button32.setName("去这里");
